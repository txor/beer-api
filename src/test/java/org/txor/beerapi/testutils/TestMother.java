...
public class TestMother {
    ...
    public static final String BEER4_NAME = "A.K.Damm";
    public static final String BEER4_TYPE = "Alsatian";
    public static final String BEER4_DESCRIPTION = "A flavoursome, full-bodied beer with an elegant appearance, A.K.Damm comes in a unique, premium bottle.";
    public static final float BEER4_GRADUATION = 4.8F;
    ...
    public static final String MANUFACTURER3_NAME = "S.A. Damm";
    public static final String MANUFACTURER3_NATIONALITY = "Spanish";
